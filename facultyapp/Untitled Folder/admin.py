        ...
        if 'update' in request.POST:
            ...
            if form.is_valid():	
                ...
                for candidate in queryset:
                    ...
                    candidate.by_user.groups.remove(Group.objects.get(name='applicant'))
...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('course_id','number_of_lectures','dissertation_project_work')
...
class GuestFacultyCourseOfferAdmin(DjangoObjectActions,admin.ModelAdmin):
    model = GuestFacultyCourseOffer
    #list_display = ('course','semester','program','guest_faculty','location','program_coordinator_id','number_students_in_class','course_offer_status',accept_reject)
    #list_display_links = ('course', accept_reject)
    ...
    def reject_course_offer(self, request, obj):
        ...
        obj.course_location_semester.assigned_count = obj.course_location_semester.assigned_count - 1
        obj.course_location_semester.save()
        ...
        if 'update' in request.POST:
            ...
            if form.is_valid():
                ...
                for course in queryset:
                    ...
                    try:   
                        gfo = GuestFacultyCourseOffer(course_location_semester=course,course=course.course,semester=course.semester,program=course.program,guest_faculty=guestfaculty,location=course.location,course_offer_status='Offered',sequence_number=faculty_course_count+1,program_coordinator_id=prog_coord.program_coordinator_id,offer_to_faculty_date=datetime.datetime.today(),number_students_in_class=course.number_of_students_in_class,max_faculty_count_reached=0)
